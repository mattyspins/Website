...
const COMMUNITY_LINKS = [
  ...
  { name: "Razed",     href: "https://www.razed.com/signup/?raf=Mattyspins" },
];
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-2 mt-5">
              ...
              <a href="https://www.instagram.com/mattyspinsslots/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                className="w-8 h-8 rounded-full bg-white/5 hover:bg-[#E4405F]/15 flex items-center justify-center transition-colors text-gray-400 hover:text-[#E4405F]">
                <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://discord.gg/n2gCDVwebw" target="_blank" rel="noopener noreferrer" aria-label="Discord"
                className="w-8 h-8 rounded-full bg-white/5 hover:bg-[#5865F2]/20 flex items-center justify-center transition-colors text-gray-400 hover:text-[#5865F2]">
                <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {PLATFORM_LINKS.map((l) => (
                <li key={l.name}>
                  <Link href={l.href} className="text-gray-400 hover:text-gray-300 text-sm transition-colors">
                    {l.name}
                  </Link>
                </li>
              ))}
              ...
              {COMMUNITY_LINKS.map((l) => (
                <li key={l.name}>
                  <a href={l.href} target="_blank" rel="noopener noreferrer"
                    className="text-gray-400 hover:text-gray-300 text-sm transition-colors inline-flex items-center gap-1.5">
                    {l.name}
          ...
          <div className="bg-red-500/5 border border-red-500/15 rounded-2xl p-5 flex items-start gap-4 max-w-2xl">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-2.5">
                ...
                <span className="text-gray-400 text-xs">Adults only</span>
              </div>
            </div>
          </div>
        </div>
