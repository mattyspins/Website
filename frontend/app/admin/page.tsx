...
const QUICK_ACCESS = [
  { href: "/admin/leaderboards", icon: <Trophy className="w-5 h-5 text-gold-400" />, bg: "bg-gold-500/10", title: "Leaderboards", desc: "Set the weekly & monthly race dates, prize splits, and resync wagers" },
